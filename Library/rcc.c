...
void RCC_DeInit (void)
{
  ...
  // Reset SW, SWS, HPRE, PPRE1, PPRE2, ADCPRE and MCO bits for stm32f103c8t6 only MCO bits [0:2]
  CLEAR_BIT (RCC->CFGR, (RCC_CFGR_SW | RCC_CFGR_SWS | RCC_CFGR_HPRE | RCC_CFGR_PPRE1 | RCC_CFGR_PPRE2 | RCC_CFGR_ADCPRE | RCC_CFGR_MCO_0 | RCC_CFGR_MCO_1 | RCC_CFGR_MCO_2));
